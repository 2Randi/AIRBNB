...
if (isset($_SESSION['utilisateur'])) {
    ...
    $lienAuth = '<span id="authText">' . $nomUtilisateur . ' ' . $prenomUtilisateur . '</span>';
    $lienDeconnexion = '<a href="biens.php">Déconnexion</a>';
} else {
    // L'utilisateur n'est pas connecté
    $lienAuth = '<a href="authentification.php"><span id="authText">LOG IN</span></a>';
    $lienDeconnexion = '';
}
?>
...
<html>
    ...
    <body>
        <div id="authContainer">
            ...
            <span id="authText"><?php echo $lienAuth; ?></span>
        </div>

        <div id="upperRightLinks">
            <span id="logoutBtn"><a href="biens.php">Déconnexion</a></span>
            <p><a href="maReservation.php">Mes réservations</a></p>
        </div>
            ...
            <section id="searchFormSection">
                <div id="searchForm">
                    <form action="utilisateurs.php" method="POST">              
                        <input type="text" name="commune" placeholder="Commune"/><br>
                        ...
                        <input type="number" name="prixMin" placeholder="Prix Min"/>
            ...
            <section>
                ...
                <section id="searchResultsSection">
                    <div class="resultCard">
                        ...
                        <a href='locations.php?idBien=<?php echo $enr['idBien']; ?>&mailProprio=<?php echo $enr['mailProprio']; ?>&dateDebut=<?php echo $dateDebut; ?>&dateFin=<?php echo $dateFin; ?>'><center>Réserver<center></a>
                        ...
                        if (!empty($resCom)) {
                            ...
                            if (!empty($avisList)) {
                                ...
                                foreach ($avisList as $avisInfo) { 
                                    ...
                                    echo "<form class='comment-form' enctype='multipart/form-data' action='' method='POST'>";
                                    echo "<input type='hidden' name='idLocation' value='" . $idLocation . "' />";
                                    echo "<textarea class='comment-textarea' name='comment' placeholder='Ajouter un commentaire...'></textarea></br>";
                                    echo "<input type='submit' class='submit-button' name='submitComment' value='Valider' />";
                                    echo "</form>";
